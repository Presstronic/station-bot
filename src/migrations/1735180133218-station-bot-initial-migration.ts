...
export class StationBotInitialMigration1735180133218 implements MigrationInterface {
    name = 'StationBotInitialMigration1735180133218'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "manufacturer" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "nickname" character varying(100), "industry" character varying(255), "isItemManufacturer" boolean NOT NULL DEFAULT false, "isVehicleManufacturer" boolean NOT NULL DEFAULT false, "uexCorpDateCreated" TIMESTAMP NOT NULL, "uexCorpDateModified" TIMESTAMP NOT NULL, "isDeleted" boolean NOT NULL DEFAULT false, "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "dateModified" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_81fc5abca8ed2f6edc79b375eeb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vehicle" ("id" SERIAL NOT NULL, "uexCorpId" integer NOT NULL, "canHaveCustomName" boolean NOT NULL DEFAULT false, "name" character varying(255) NOT NULL, "shortName" character varying(100), "cargoScuSize" double precision NOT NULL DEFAULT '0', "crewSize" integer NOT NULL DEFAULT '0', "rsiStoreURL" text, "rsiBrochureUrl" text, "rsiVideoUrl" text, "padSize" character varying(50), "gameVersion" character varying(50), "isDeleted" boolean NOT NULL DEFAULT false, "uexCorpDateCreated" TIMESTAMP NOT NULL, "uexCorpDateModified" TIMESTAMP NOT NULL, "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "dateModified" TIMESTAMP NOT NULL DEFAULT now(), "manufacturerId" integer, CONSTRAINT "PK_187fa17ba39d367e5604b3d1ec9" PRIMARY KEY ("id"))`);
