...
describe('getSecondsSinceLastNominationByUser', () => {
  it('returns null when database is not configured', async () => {
    ...
    const { getSecondsSinceLastNominationByUser } = await import('../nominations.repository.js');
...
describe('countNominationsForTargetInWindow', () => {
  it('returns 0 when database is not configured', async () => {
    ...
    const { countNominationsForTargetInWindow } = await import('../nominations.repository.js');
...
describe('countNominationsByUserInWindow', () => {
  it('returns 0 when database is not configured', async () => {
    ...
    const { countNominationsByUserInWindow } = await import('../nominations.repository.js');
